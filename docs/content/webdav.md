...
Fastmail Files, ownCloud, Nextcloud or dCache rclone will support hashes.
Fastmail Files and ownCloud supports SHA1 and MD5, Nextcloud supports MD5 and dCache supports ADLER32, MD5, SHA1, SHA256 and SHA512.
...
Don't enter a username or password, instead enter your Macaroon as the `bearer_token`.
